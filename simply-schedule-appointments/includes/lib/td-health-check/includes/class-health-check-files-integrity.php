 ...
 */
class TD_Health_Check_Files_Integrity {
	...
	static function run_files_integrity_check() {
		...
		$checksums = TD_Health_Check_Files_Integrity::call_checksum_api();

		$files = TD_Health_Check_Files_Integrity::parse_checksum_results( $checksums );

		TD_Health_Check_Files_Integrity::create_the_response( $files );
