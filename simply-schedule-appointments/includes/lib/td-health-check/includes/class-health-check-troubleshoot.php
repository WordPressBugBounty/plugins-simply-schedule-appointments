...
/**
 * Class TD_Health_Check_Troubleshoot
 */
class TD_Health_Check_Troubleshoot {
	 ...
	 * @uses TD_Health_Check::display_notice()
	 * @uses esc_html__()
	 * @uses WP_Filesystem::copy()
	 * @uses trailingslashit()
	 * @uses TD_Health_Check_Troubleshoot::session_started()
	 *
	 * @return bool
	 */
	...
	static function maybe_update_must_use_plugin() {
		...
		$current = get_plugin_data( trailingslashit( TD_HEALTH_CHECK_PLUGIN_DIRECTORY ) . 'assets/mu-plugin/health-check-troubleshooting-mode.php' );
	 ...
	 * @uses TD_Health_Check::get_filesystem_credentials()
	 * @uses TD_Health_Check_Troubleshoot::setup_must_use_plugin()
	 * @uses TD_Health_Check_Troubleshooting_MU::is_troubleshooting()
	 * @uses esc_url()
	 * @uses add_query_arg()
	 * @uses esc_html_e()
	 *
	...
	static function show_enable_troubleshoot_form() {
		...
		if ( class_exists( 'TD_Health_Check_Troubleshooting_MU' ) ) {
			$troubleshooting = new TD_Health_Check_Troubleshooting_MU();
		}
