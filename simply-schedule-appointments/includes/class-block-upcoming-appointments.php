...
class SSA_Block_Upcoming_Appointments {
	...
	public function hooks() {
		add_action( 'init', array( $this, 'maybe_register_upcoming_appointment_block' ) );
	}
	
	public function maybe_register_upcoming_appointment_block() {
		if( ssa_doing_async() ) {
			return;
		}
		...
		return $this->register_upcoming_appointment_block();
	}
