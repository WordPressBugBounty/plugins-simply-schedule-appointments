...
$translations = array (
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'download_error' => __( 'The backup could not be downloaded. It may have expired.', 'simply-schedule-appointments' ),
  ...
  array (
    ...
    array (
      ...
      'probeButton' => __( 'Check this event on Google now', 'simply-schedule-appointments' ),
      'probeLoading' => __( 'Checking...', 'simply-schedule-appointments' ),
      'probeError' => __( 'Could not reach Google.', 'simply-schedule-appointments' ),
      'probeHttp' => __( 'Response code:', 'simply-schedule-appointments' ),
      'probeAccess' => __( 'Calendar access:', 'simply-schedule-appointments' ),
      'probeMarker' => __( 'Marker on the event:', 'simply-schedule-appointments' ),
      'probeMarkerNone' => __( 'Not present', 'simply-schedule-appointments' ),
      'probeExpected' => __( 'Marker this site expects:', 'simply-schedule-appointments' ),
      'probeHomeUrl' => __( 'Site address:', 'simply-schedule-appointments' ),
      'probeRaw' => __( 'Show the full response from Google', 'simply-schedule-appointments' ),
      'probeVerdicts' => 
      array (
        'would_skip' => __( 'The marker matches, so SSA would skip this event. If it is in the table anyway, the row predates the current marker or the sync has not run since.', 'simply-schedule-appointments' ),
        'marker_mismatch' => __( 'The marker does not match this site, so SSA no longer recognizes its own event. The site address or the security salt changed after this event was booked.', 'simply-schedule-appointments' ),
        'marker_absent' => __( 'This event carries no marker, so SSA cannot tell that it created it.', 'simply-schedule-appointments' ),
        'access_hides_marker' => __( 'This calendar is shared as free and busy only. Google hides the marker and SSA skips the check, so every event here is treated as external.', 'simply-schedule-appointments' ),
        'event_missing' => __( 'Google no longer has this event. The cached row is stale and should have been cleared by a sync.', 'simply-schedule-appointments' ),
        'request_failed' => __( 'The request to Google did not succeed.', 'simply-schedule-appointments' ),
      ),
      'reclaimButton' => __( 'Mark this event as created by this site', 'simply-schedule-appointments' ),
      'reclaimWarning' => __( 'This writes to the live Google event and cannot be undone here. Only continue if this event was booked through this site. If it belongs to another site or another person, this site will stop treating it as busy time and may double book it.', 'simply-schedule-appointments' ),
      'reclaimConfirmPrompt' => __( 'Type the word reclaim to confirm.', 'simply-schedule-appointments' ),
      'reclaimConfirmWord' => __( 'reclaim', 'simply-schedule-appointments' ),
      'reclaimConfirmButton' => __( 'Confirm and update Google', 'simply-schedule-appointments' ),
      'reclaimCancel' => __( 'Cancel', 'simply-schedule-appointments' ),
      'reclaimWorking' => __( 'Updating Google...', 'simply-schedule-appointments' ),
      'reclaimDone' => __( 'Done. Google now recognizes this event as belonging to this site, and the cached row was removed.', 'simply-schedule-appointments' ),
      'reclaimCacheWarning' => __( 'The availability cache could not be cleared. It will refresh on its own shortly.', 'simply-schedule-appointments' ),
      'reclaimRowWarning' => __( 'The cached row had already changed, so it was left alone. The next sync will clear it.', 'simply-schedule-appointments' ),
      'driftTitle' => __( 'Events created by this site are being counted as busy', 'simply-schedule-appointments' ),
      'driftIntro' => __( 'These appointments were booked through this site but Google no longer recognizes them as ours, so they are blocking their own time slots. Fixing them marks each event in Google again and clears it from the busy list. This does not email anyone.', 'simply-schedule-appointments' ),
      'driftButton' => __( 'Fix these events', 'simply-schedule-appointments' ),
      'driftFixing' => __( 'Fixing...', 'simply-schedule-appointments' ),
      'driftUntitled' => __( 'Untitled event', 'simply-schedule-appointments' ),
      'driftSomeFailed' => __( 'Some events could not be fixed. Try again or check them individually.', 'simply-schedule-appointments' ),
      'driftAllFixed' => __( 'Done. These events are no longer blocking their own slots.', 'simply-schedule-appointments' ),
      'driftBatchFixed' => __( 'This batch was fixed. There may be more, so open this again to check.', 'simply-schedule-appointments' ),
      'driftTruncated' => __( 'Only the first events are shown. Fix these, then open this again to check for more.', 'simply-schedule-appointments' ),
      'driftUnverified' => __( 'Some events could not be checked against Google, so this list may be incomplete. Check the Google Calendar connection and try again.', 'simply-schedule-appointments' ),
      'driftError' => __( 'Could not check for drifted events.', 'simply-schedule-appointments' ),
      'reclaimBlockedLabel' => __( 'Cannot be claimed:', 'simply-schedule-appointments' ),
      'reclaimReasons' => 
      array (
        'no_local_appointment' => __( 'No appointment on this site is linked to this event, so this site cannot claim it. It was most likely created by a different site sharing this calendar.', 'simply-schedule-appointments' ),
        'ambiguous_local_appointment' => __( 'More than one appointment on this site points at this event, so SSA will not guess which one is right.', 'simply-schedule-appointments' ),
        'appointment_id_mismatch' => __( 'The event points at a different appointment than the one linked to it here.', 'simply-schedule-appointments' ),
        'times_do_not_match' => __( 'The times on the Google event do not match the appointment linked to it here.', 'simply-schedule-appointments' ),
        'appointment_canceled' => __( 'The linked appointment is canceled, so there is nothing to free up.', 'simply-schedule-appointments' ),
        'appointment_in_the_past' => __( 'The linked appointment has already passed, so claiming it would not free up any time.', 'simply-schedule-appointments' ),
        'event_not_marked_by_ssa' => __( 'This event carries none of the details SSA writes when it creates an event.', 'simply-schedule-appointments' ),
        'calendar_out_of_scope' => __( 'This calendar is not checked by the selected appointment type.', 'simply-schedule-appointments' ),
        'access_hides_marker' => __( 'This calendar is shared as free and busy only, so Google will not store the marker.', 'simply-schedule-appointments' ),
        'event_unreadable' => __( 'Google did not return this event.', 'simply-schedule-appointments' ),
        'missing_identifiers' => __( 'This event is missing the details needed to identify it.', 'simply-schedule-appointments' ),
      ),
    ),
